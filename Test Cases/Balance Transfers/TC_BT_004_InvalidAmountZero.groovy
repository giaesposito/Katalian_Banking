...
/**
 * TC_BT_004 - Invalid Amount: Zero
 *
 * Verifies that submitting a transfer with an amount of zero is rejected
...
// --- Step 4: Enter zero amount ---
WebUI.clearText(findTestObject('Page_Transfer/input_Amount'))
WebUI.setText(findTestObject('Page_Transfer/input_Amount'), '0')
